...
urlpatterns = [
    ...
    re_path(r'^portfolio_details$', views.portfolio_details, name='portfolio_details'),
    ...
    re_path(r'^owner_viewgivework$', views.owner_viewgivework, name='owner_viewgivework'),
